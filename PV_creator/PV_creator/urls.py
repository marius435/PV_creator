...
urlpatterns = [
    ...
    path('addLocation/', views.addLocation.as_view(), name='addLocation'),
    path('addDepartament/', views.addDepartament.as_view(), name='addDepartament'),
    path('addObjectType/', views.addObjectType.as_view(), name='addObjectType'),
